...
export const errorProcessGraphics = `${colors.FgRed}Graphics page is undefined or empty! Make sure you have defined graphic pages via cli argument --graphicPages.`;
...
export const errorProcessDescriptions = `${colors.FgRed}No sheet or name for processDescriptions()!`;
export const errorProcessDescriptionsNoConfig = `${colors.FgRed}No config provided to processDescriptions()!`;
...
export const errorSetupGenericTokensMissingProps = `${colors.FgRed}Missing "name" or "characters" properties in Generic frame!`;
export const errorSetupGenericTokensNoFrame = `${colors.FgRed}No frame for setupGenericTokens()!`;
export const errorSetupGenericTokensNoChildren = `${colors.FgRed}Generic frame has no children!`;
...
export const errorWriteTokens = `${colors.FgRed}Less than one token provided to writeTokens()! Make sure you have defined token pages via cli argument --tokenPages.`;
export const errorWriteTokensNoSettings = `${colors.FgRed}Missing "settings" argument/object when attempting to write tokens!`;
export const errorWriteDescription = `${colors.FgRed}Less than one description provided to writeDescription()!`;
export const errorWriteDescriptionNoSettings = `${colors.FgRed}Missing "settings" argument/object when attempting to write token description!`;
